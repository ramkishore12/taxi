...
<div class="webbooking_container">
	<form id="front_form" style="display: none;">
			...
			<div class="owl-carousel owl-theme">
				...
				?>
					<div class="item sel-model" data-model="pack" data-model_name="package">
						<img class="active_img" src="<?php echo URL_BASE;?>public/webbooking/images/pack_active.png" alt="<?php echo __('package'); ?>" title="<?php echo __('package'); ?>">
					   	<img class="normal_img" src="<?php echo URL_BASE;?>public/webbooking/images/pack.png" alt="<?php echo __('package'); ?>" title="<?php echo __('package'); ?>">
		...
		<div class="form-group days_count" style="display:none;">
	...
	<div id="fare_est_block" class="fare_est_block" style="display: none;">
		...
		<ul id="fare_details">
			...
			<li><p id="app_distance"></p><span><?php echo __('distance'); ?></span></li>
			<li><p id="company_tax"></p><span><?php echo __('tax'); ?></span></li>
			<li><p id="approx_fare"></p><span><?php echo __('approx_fare'); ?></span></li>
		</ul>
	...
	<div class="signup_steps signup_step1">
		...
		<form name="get_mobileno_form" method="post" autocomplete="off">
			...
			<div class="new_acc_create">
				<a href="<?php echo URL_BASE;?>users/fconnect_login" title="<?php echo __('login_with_facebook');?>"><img src="<?php echo URL_BASE.PUBLIC_UPLOADS_LANDING_FOLDER;?>fb.png" style="width:100%; padding-bottom: 15px;"  alt="<?php echo __('login_with_facebook');?>" /></a>
 
                <a href="<?php echo URL_BASE;?>users/googleplus_login" title="<?php echo __('login_with_google');?>" ><img src="<?php echo URL_BASE.PUBLIC_UPLOADS_LANDING_FOLDER;?>Google.png" style="width:100%"  alt="<?php echo __('login_with_google');?>"  /></a>
	...
	<div class="signup_steps signup_step3" style="display: none;">
		...
		<form name="signup_form" method="post" onsubmit="booking.html">
			...
			<div class="form-group password_icon">
				<i class="pwd_ico"></i>
				<input type="password" name="password" id="pass_password" class="form-control show_password" placeholder="<?php echo __('password'); ?>" title="<?php echo __('password'); ?>" value=""/>
	...
	<div class="signup_steps signup_step5" style="display: none;">
		...
		<form name="signin_mobile_form" id="signin_mobile_form" method="post" autocomplete="off">
			...
			<div style="display: none;" class="new_acc_create">
                ...
                <a href="<?php echo URL_BASE;?>users/googleplus_login" title="<?php echo __('login_with_google');?>" ><img src="<?php echo URL_BASE.PUBLIC_UPLOADS_LANDING_FOLDER;?>Google.png" style="width:100%; padding-bottom: 15px; "  alt="<?php echo __('login_with_google');?>"  /></a>
...
<script type="text/javascript">
	...
	{
		var pass = 1;
		var package = $('#package_plan').val();
		/*if(modelID == 'pack')
		{
			package = $('#package_plan').val();
			if(package == '')
			{
				pass = 0;
			}
		...
		if(pass == 1)
		{
			$.ajax({
				...
				type: "post",
				data: "pickup_latitude="+ pickup_latitude +"&pickup_longitude="+ pickup_longitude+"&pickup_location="+ pickup_location +"&drop_location="+ drop_location +"&modelID="+ modelID+"&package="+ package,
				beforeSend:function() {
	        ...
	        directionsService.route(request, function(response, status) {
	        	if (status === 'OK') {
	                ...
	                for (var i = 0; i < route.legs.length; i++) {
	                    ...
	                    total_distance += parseFloat(route.legs[i].distance.text);
	                ...
	                // checking up & down total distance
	                /*var updown_duration = parseFloat(total_duration)*2;
	                if(updown_duration > min_round_trip){
	...
	$("#ride_later").click(function(){
		...
		if(error_free_form == 0)
		{
			...
			if(pass_log == 0)
			{
				...
				localStorage.setItem('page_redirect', '0');
				submit_form($(this).val());
			}
		}
	});
	...
	{
		localStorage.setItem('modelIds', $('#modelIds').val());
		localStorage.setItem('pass_logged_in', $('#pass_logged_in').val());
		localStorage.setItem('pickup_location', $('#pickup_location').val());
		localStorage.setItem('pass_latitude', $('#pass_latitude').val());
		localStorage.setItem('pass_longitude', $('#pass_longitude').val());
		localStorage.setItem('pickup_latitude', $("#pickup_latitude").val());
		localStorage.setItem('pickup_longitude', $("#pickup_longitude").val());
		localStorage.setItem('pickup_date', $("#pickup_date").val());
		localStorage.setItem('ride_type', $('#ride_type').val());
		localStorage.setItem('drop_location', $('#drop_location').val());
		localStorage.setItem('drop_latitude', $('#drop_latitude').val());
		localStorage.setItem('drop_longitude', $('#drop_longitude').val());
		localStorage.setItem('select_model', $("#select_model").val());
		localStorage.setItem('select_model_name', $("#select_model_name").val());
		localStorage.setItem('page_redirect', $("#page_redirect").val());

		/* for package */
		localStorage.setItem('package_type', $("#package_type").val());
		localStorage.setItem('package_fleet', $("#package_fleet").val());
		localStorage.setItem('package_plan', $("#package_plan").val());
		localStorage.setItem('rental_outstation', $("#rental_outstation").val());
		localStorage.setItem('rent_out_plan_id', $("#rent_out_plan_id").val());
		localStorage.setItem('trip_type', $("#trip_type").val());
		localStorage.setItem('package_os_type', $("#package_os_type").val());
		localStorage.setItem('os_days_count', $("#os_days_count").val());
		/* for package */
	}
	...
	function submit_form(now_after)
	{
        ...
        var os_trip_type = '';
        var os_days_count = '';
        if(localStorage.getItem('page_redirect') == '1')
        {
        	var pickupdate_time = localStorage.getItem('pickup_date');
	        var passenger_id = $("#pass_logged_in").val();
	        var latitude = localStorage.getItem('pickup_latitude');
	        var longitude = localStorage.getItem('pickup_longitude');
	        var motor_model = localStorage.getItem('modelIds');
	        var pickupplace = localStorage.getItem('pickup_location');
	        var dropplace = localStorage.getItem('select_model');
	        var drop_latitude = localStorage.getItem('drop_latitude');
	        var drop_longitude = localStorage.getItem('drop_longitude');
	        var promo_code = '';
	        var sub_logid = passenger_id;
	        var rental_outstation = localStorage.getItem('rental_outstation');
	        var rent_out_plan_id = localStorage.getItem('rent_out_plan_id');
        } else {
	...
	$(document).ready(function(){
		...
		$("#mobile , #signin_mobile").keyup(function() {
		...
		if(localStorage.getItem('page_redirect') == '1')
        {
        	$('#modelIds').val(localStorage.getItem('modelIds'));
			//$('#pass_logged_in').val(localStorage.getItem('pass_logged_in'));
			$('#pickup_location').val(localStorage.getItem('pickup_location'));
			$('#pass_latitude').val('');
			$('#pass_longitude').val('');
			$('#pickup_latitude').val(localStorage.getItem('pickup_latitude'));
			$('#pickup_longitude').val(localStorage.getItem('pickup_longitude'));
			$('#pickup_date').val(localStorage.getItem('pickup_date'));
			$('#ride_type').val(localStorage.getItem('ride_type'));
			$('#drop_location').val(localStorage.getItem('drop_location'));
			$('#drop_latitude').val(localStorage.getItem('drop_latitude'));
			$('#drop_longitude').val(localStorage.getItem('drop_longitude'));
			$('#select_model').val(localStorage.getItem('select_model'));
			$('#select_model_name').val(localStorage.getItem('select_model_name'));
			$('#page_redirect').val('0');

			$('#package_type').val(localStorage.getItem('package_type'));
			$('#package_fleet').val(localStorage.getItem('package_fleet'));			
			$('#rental_outstation').val(localStorage.getItem('rental_outstation'));
			$('#rent_out_plan_id').val(localStorage.getItem('rent_out_plan_id'));
			$('#trip_type').val(localStorage.getItem('trip_type'));

			if(localStorage.getItem('rental_outstation') == '2')
			{
				$('.package-plan-os-sec').show();
				$('#package_os_type').val(localStorage.getItem('package_os_type'));
				if(localStorage.getItem('package_os_type') == '2')
				{
					$('.days_count').show();
					$("#ride_now").hide();
					$('#os_days_count').val(localStorage.getItem('os_days_count'));
				} else {
					$("#ride_now").show();
					$('.days_count').hide();
				}
			...
			$("div").find("[data-model='" + localStorage.getItem('select_model') + "']").addClass('active');

			if(localStorage.getItem('select_model') == 'pack')
			{
				$('.package-plan-sec').show();
			...
			$('#package_plan').val(localStorage.getItem('package_plan'));
			fare_estimate();
        }
		...
		$("#signin_submit").click(function(){
			...
			if($("#mobile").val().length < 7){
		    	...
		    	$("#mobileno_tooltip").html("<?php echo __('Minimum number should be 7'); ?>");
		    	return false;
			}
			if(error_free_form == 0)
			{ 
		...
		if(error_free_form == 1)
		{
            ...
            console.log("pass_submit",parameter);
		    var formData = "input=" + parameter;
		    $.ajax({
		        url: URL_BASE + 'decrypt/encrypt',
		        type: 'post',
	...
	function loadPackagePlans(model, type)
	{
		if(model != '')
		{
			...
			if(localStorage.getItem('package_plan') != 'null')
			{
				var selected = localStorage.getItem('package_plan');
			}
